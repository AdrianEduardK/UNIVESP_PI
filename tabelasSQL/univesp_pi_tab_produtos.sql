...
INSERT INTO `tab_produtos` VALUES (3,'Fibra de Poliéster'),(4,'Polipropileno (PP) virgem'),(5,'CARPETE REFILADO VINIL'),(6,'CARPETE REFILADO COMPOSTO'),(7,'CARPETE REFILADO MOIDO'),(8,'CARPETE MOIDO CONFECÇÃO'),(9,'CARPETE REFILADO x');
