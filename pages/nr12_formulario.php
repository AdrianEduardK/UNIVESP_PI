...
<body>
    ...
    <form method="POST" action="../php/salvar_nr12.php">
        ...
        <div class="info-row">
            <label>Horário Início: <input type="time" name="inicio" value="<?php echo isset($nr12_data['NR12_INICIO']) ? substr($nr12_data['NR12_INICIO'], 0, 5) : ''; ?>" required></label>
            <label>Horário Fim: <input type="time" name="fim" value="<?php echo isset($nr12_data['NR12_FIM']) ? substr($nr12_data['NR12_FIM'], 0, 5) : ''; ?>" required></label>
            <label>Operador: <input type="text" name="operador" value="<?php echo isset($nr12_data['NR12_OPERADOR']) ? htmlspecialchars($nr12_data['NR12_OPERADOR']) : ''; ?>" required></label>
        </div>
            ...
            <tbody>
                ...
                foreach ($questions as $num => $question) {
                    ...
                    foreach ($options as $option) {
                        ...
                        echo "<td class='options'><input type='radio' name='Q$num' value='$option' $checked required></td>";
                    }
        ...
        <label>Observações:<br>
            <textarea name="obs" rows="4" cols="50"><?php echo isset($nr12_data['NR12_OBS']) ? htmlspecialchars($nr12_data['NR12_OBS']) : ''; ?></textarea>
        </label><br><br>
